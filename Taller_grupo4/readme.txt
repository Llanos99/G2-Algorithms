Taller grupo 4 / Finding roots - Algoritmos G2
...
para poder parar (ceil(x) es la funcion piso, el minimo valor entero >= que x). Este valor nos da la cota maxima de iteraciones o el peor caso.

En el caso especifico de la actividad tolerance = t = 0.0001, a=0 y b=1000, de modo que:

  			n = floor(log2(1000/0.0001)) = ceil=(23.24) = 24 iteraciones.
